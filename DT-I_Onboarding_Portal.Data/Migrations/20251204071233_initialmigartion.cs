        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WelcomeEmailSentAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastSendError = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewJoiners", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewJoiners_Email_StartDate",
                table: "NewJoiners",
                columns: new[] { "Email", "StartDate" },
                unique: true);

...
- Create Angular project with ng: `ng new dt-i_onboarding_portal.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dt-i_onboarding_portal.client.esproj`).
